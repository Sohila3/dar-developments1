    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="mb-3 text-[#0B1A2E]/70 text-justify">{t("landmark", "location")}</p>
          ...
          <p className="mb-3 text-[#0B1A2E]/70 text-justify" style={{ whiteSpace: "pre-line" }}>
            {t("landmark", "spaces")}
          </p>
        ...
        <div className="max-w-6xl mx-auto trust-grid">
          ...
          <div className="trust-right" style={{
            ...
            {[
              ...
              { num: "+150", ar: "وحدة سكنية تم تسليمها بنجاح",  en: "Units Successfully Delivered" },
