    ...
    >
      <style>{`
        ...
        .custom-input {
          ...
          margin-bottom: 16px; direction: ${dir}; display: block;
        }
        ...
        .trust-stat-lbl {
          font-size: 14px; color: rgba(250,246,238,0.55);
        }
        .trust-cta-btn {
          background: #C9A84C; color: #0B1A2E;
  ...
  >
    ...
    {error}
      ...
      <section className="px-6 md:px-24 pb-28" style={{ direction: dir }}>
        <div className="max-w-6xl mx-auto trust-section shadow-xl">

          {/* LEFT — DARK */}
          <div
            className="trust-left"
            style={{ order: lang === "ar" ? 1 : 2 }}
          >
            {/* BG ORBS */}
            <div style={{
          ...
          >
            {[
              ...
              <div key={i} className="trust-stat" style={{ textAlign: lang === "ar" ? "right" : "left" }}>
                ...
                <span className="trust-stat-lbl" style={{ color: "rgba(30,58,95,0.55)" }}>
                  {lang === "ar" ? s.ar : s.en}
                </span>
              </div>
            ))}
